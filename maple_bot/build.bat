...
chcp 65001 > nul
echo ========================================
echo  Claude v2.4.4 Build (PyArmor + PyInstaller)
echo ========================================
...
if exist dist\Claude_2.4.4 rmdir /s /q dist\Claude_2.4.4
...
xcopy /E /I /Y .obf_build\dist\Claude dist\Claude_2.4.4
xcopy /E /I /Y .obf_build\core dist\Claude_2.4.4\core
xcopy /E /I /Y .obf_build\core_ui dist\Claude_2.4.4\core_ui
xcopy /E /I /Y .obf_build\ui dist\Claude_2.4.4\ui
if exist dist\Claude_2.4.4\_internal xcopy /E /I /Y .obf_build\core dist\Claude_2.4.4\_internal\core
if exist dist\Claude_2.4.4\_internal xcopy /E /I /Y .obf_build\core_ui dist\Claude_2.4.4\_internal\core_ui
if exist dist\Claude_2.4.4\_internal xcopy /E /I /Y .obf_build\ui dist\Claude_2.4.4\_internal\ui
"%PYTHON%" build_release_config.py config.json dist\Claude_2.4.4\config.json
if errorlevel 1 (echo Release config generation failed & exit /b 1)
copy /Y version.txt dist\Claude_2.4.4\version.txt
if exist templates xcopy /E /I /Y templates dist\Claude_2.4.4\templates
if exist monsters xcopy /E /I /Y monsters dist\Claude_2.4.4\monsters
if exist models xcopy /E /I /Y models dist\Claude_2.4.4\models
if exist maps xcopy /E /I /Y maps dist\Claude_2.4.4\maps
if exist "third_party\Interception-v1.0.1\Interception\library\x64\interception.dll" copy /Y "third_party\Interception-v1.0.1\Interception\library\x64\interception.dll" "dist\Claude_2.4.4\interception.dll"

for /d /r "dist\Claude_2.4.4" %%D in (__pycache__) do @if exist "%%D" rmdir /s /q "%%D"
del /s /q "dist\Claude_2.4.4\*.pyc" >nul 2>&1

echo.
echo ========================================
echo  Done! dist\Claude_2.4.4\Claude.exe
echo ========================================
