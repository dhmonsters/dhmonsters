...
chcp 65001 > nul
echo ========================================
echo  Claude v2.1.5 Build (PyArmor + PyInstaller)
echo ========================================
