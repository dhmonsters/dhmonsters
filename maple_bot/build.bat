...
chcp 65001 > nul
echo ========================================
echo  Claude v2.2.0 Build (PyArmor + PyInstaller)
echo ========================================
...
if exist dist\Claude rmdir /s /q dist\Claude
...
xcopy /E /I /Y .obf_build\dist\Claude dist\Claude
copy /Y config.json dist\Claude\config.json
copy /Y version.txt dist\Claude\version.txt
if exist templates xcopy /E /I /Y templates dist\Claude\templates
if exist monsters xcopy /E /I /Y monsters dist\Claude\monsters
if exist models xcopy /E /I /Y models dist\Claude\models
if exist "third_party\Interception-v1.0.1\Interception\library\x64\interception.dll" copy /Y "third_party\Interception-v1.0.1\Interception\library\x64\interception.dll" "dist\Claude\interception.dll"
